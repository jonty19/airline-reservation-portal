...
<html>
  <head>
    ...
    if(isset($_POST['UploadBtn'])){
      ...
      $from= $_POST['fr'];
      $to = $_POST['to'];
      $query = mysql_query("insert into domestic(name, id_no, email, age, phone_no, date, timing, airline_from, airline_to) values ('$name', '$id','$email','$age','$phone','$date','$timing','$from','$to')");
  ...
  <body>
    <h1 class="text-center text-info">Domestic Flights Booking Portal</h1> <hr> <hr>
